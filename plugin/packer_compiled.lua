...
_G.packer_plugins = {
  ...
  LuaSnip = {
    loaded = true,
    path = "/home/snsm/.local/share/nvim/site/pack/packer/start/LuaSnip"
  },
  ["codi.vim"] = {
    commands = { "Codi" },
    loaded = false,
  ...
  ["nvim-autopairs"] = {
    loaded = true,
    path = "/home/snsm/.local/share/nvim/site/pack/packer/start/nvim-autopairs"
  },
  ["nvim-bufferline.lua"] = {
    loaded = true,
  ...
  ultisnips = {
    loaded = true,
    path = "/home/snsm/.local/share/nvim/site/pack/packer/start/ultisnips"
  },
  ["vim-abolish"] = {
    loaded = true,
